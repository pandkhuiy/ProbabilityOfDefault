function [PCC, AUC, PG,BS, KS, H] = rbfSVM(X1,X2,X3,X4,y1,y2,y3,y4)
...
[C_optimal_PCC, C_optimal_AUC, C_optimal_PG, C_optimal_BS, C_optimal_H, C_optimal_KS, ...
  S_optimal_PCC, S_optimal_AUC, S_optimal_PG, S_optimal_BS, S_optimal_H, S_optimal_KS] =  optimizeRbfSVM(Xtrain123, ytrain123, useAdaSyn);
...
if useAdaSyn == 1
    ...
    % measure
    trainedSVMModelPCC = fitcsvm([XAdaSyn;Xtrain123],[double(yAda);ytrain123],'BoxConstraint',C_optimal_PCC,'KernelFunction','rbf','KernelScale',S_optimal_PCC,'ClassNames',[0,1]);
    trainedSVMModelKS = fitcsvm([XAdaSyn;Xtrain123],[double(yAda);ytrain123],'BoxConstraint',C_optimal_KS,'KernelFunction','rbf','KernelScale',S_optimal_KS,'ClassNames',[0,1]);
    trainedSVMModelAUC = fitcsvm([XAdaSyn;Xtrain123],[double(yAda);ytrain123],'BoxConstraint',C_optimal_AUC,'KernelFunction','rbf','KernelScale',S_optimal_AUC,'ClassNames',[0,1]);
    trainedSVMModelPG = fitcsvm([XAdaSyn;Xtrain123],[double(yAda);ytrain123],'BoxConstraint',C_optimal_PG,'KernelFunction','rbf','KernelScale',S_optimal_H,'ClassNames',[0,1]);
    trainedSVMModelH = fitcsvm([XAdaSyn;Xtrain123],[double(yAda);ytrain123],'BoxConstraint',C_optimal_H,'KernelFunction','rbf','KernelScale',S_optimal_PG,'ClassNames',[0,1]);
    trainedSVMModelBS = fitcsvm([XAdaSyn;Xtrain123],[double(yAda);ytrain123],'BoxConstraint',C_optimal_BS,'KernelFunction','rbf','KernelScale',S_optimal_BS,'ClassNames',[0,1]);
    ...
    % Now fit a SVM with the optimal hyperparameter for each performance
    % measure
    trainedSVMModelPCC = fitcsvm(Xtrain123,ytrain123,'BoxConstraint',C_optimal_PCC,'KernelFunction','rbf','KernelScale',S_optimal_PCC,'ClassNames',[0,1]);
    trainedSVMModelKS = fitcsvm(Xtrain123,ytrain123,'BoxConstraint',C_optimal_KS,'KernelFunction','rbf','KernelScale',S_optimal_KS,'ClassNames',[0,1]);
    trainedSVMModelAUC = fitcsvm(Xtrain123,ytrain123,'BoxConstraint',C_optimal_AUC,'KernelFunction','rbf','KernelScale',S_optimal_AUC,'ClassNames',[0,1]);
    trainedSVMModelPG = fitcsvm(Xtrain123,ytrain123,'BoxConstraint',C_optimal_PG,'KernelFunction','rbf','KernelScale',S_optimal_H,'ClassNames',[0,1]);
    trainedSVMModelH = fitcsvm(Xtrain123,ytrain123,'BoxConstraint',C_optimal_H,'KernelFunction','rbf','KernelScale',S_optimal_PG,'ClassNames',[0,1]);
    trainedSVMModelBS = fitcsvm(Xtrain123,ytrain123,'BoxConstraint',C_optimal_BS,'KernelFunction','rbf','KernelScale',S_optimal_BS,'ClassNames',[0,1]);
